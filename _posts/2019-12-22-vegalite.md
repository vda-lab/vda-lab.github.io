...
{:.exercise}
**Exercise 1** - Add an additional bar to the plot with a value of 100.

{:.exercise}
**Exercise 2** - Change the mark type from `bar` to `point`.

{:.exercise}
**Exercise 3** - Looking at the vega-lite documentation at [https://vega.github.io/vega-lite/docs/](https://vega.github.io/vega-lite/docs/), check what other types of mark are available. See which of these actually work with this data.

{:.exercise}
**Exercise 4** - How would you make this an horizontal chart?
<!--
Flip x and y
-->
...
{:.exercise}
**Exercise 5** - Add a new field to the datapoints in the dataset with some integer value, called `new_field`. Next, change the plot so that you have a scatterplot with this new field on the y-axis and the field `b` on the x-axis.
<!--
{
